...
class ReviewsCollectionView(APIView):
    ...
    def get(self, request):
        """Return reviews with optional filters and ordering."""
    ...
    def post(self, request):
        """Create a review from a customer profile."""
...
class ReviewDetailView(APIView):
    ...
    def patch(self, request, review_id):
        """Update rating/description for the review owner."""
    ...
    def delete(self, request, review_id):
        """Delete the review if the requester is the owner."""
        review = get_object_or_404(Review, id=review_id)
        if review.reviewer_id != request.user.id:
            return Response(
                {"detail": "You do not have permission to modify this review."},
